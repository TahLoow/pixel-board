/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 922223d68a33c3af3edb69a5745873ac)
// Runtime types generated with workerd@1.20251217.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PixelBoardDurableObject";
	}
	interface Env {
		TURNSTILE_SECRET_KEY: string;
		JWT_PRIVATE_KEY: string;
		JWT_MAX_AGE: string;
		PIXEL_BOARD_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").PixelBoardDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SECRET_KEY" | "JWT_PRIVATE_KEY" | "JWT_MAX_AGE">> {}
}
declare module "*.sql" {
	const value: string;
